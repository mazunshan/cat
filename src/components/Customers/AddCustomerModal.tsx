        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <span className="text-lg font-semibold mb-1">零售客户</span>
                <span className="text-sm text-gray-500">全款或货到付款</span>
              </button>
              
              <button
                type="button"
                onClick={() => setFormData(prev => ({ ...prev, customerType: 'installment' }))}
                className={`p-4 rounded-lg border-2 flex flex-col items-center transition-colors ${
              ...
              >
                <span className="text-lg font-semibold mb-1">分期客户</span>
                <span className="text-sm text-gray-500">按月分期付款</span>
              </button>
            </div>
          </div>
