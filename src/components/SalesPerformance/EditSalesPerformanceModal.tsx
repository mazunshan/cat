...
import { SalesPerformance, User, Team } from '../../types';
import { useAuth } from '../../context/AuthContext';

interface EditSalesPerformanceModalProps {
  isOpen: boolean;
}

const EditSalesPerformanceModal: React.FC<EditSalesPerformanceModalProps> = ({
  isOpen,
  teams
}) => {
  const { user } = useAuth();
